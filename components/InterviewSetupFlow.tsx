  ...
  const handleFinish = async (scheduleType: "NOW" | "LATER") => {
    ...
    try {
      const result = await createInterview({
        ...
        questions: [], // Questions will be generated by the AI agent during the call if empty
      });
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <button
                ...
                className={`p-6 rounded-xl border-2 transition-all flex flex-col items-center gap-4 ${
                  interviewType === "AI" ? "border-primary-200 bg-primary-200/10" : "border-dark-200 hover:border-light-600"
                }`}
              >
              ...
              <button
                ...
                className={`p-6 rounded-xl border-2 transition-all flex flex-col items-center gap-4 ${
                  interviewType === "RESUME" ? "border-primary-200 bg-primary-200/10" : "border-dark-200 hover:border-light-600"
                }`}
              >
